<nav class=" navbar-custom">
    <div class="col-md-12 col-xs-12 row" style="height: 100%;">
        ...
        @else
            <a href="{{ route('profile') }}" class="col-md-1 " style="padding: 0px">
                <img  src="{{ asset('img/profile/'. Auth::user()->avatar) }}" style="padding-left:10px;max-height: 130px;float: left;border-radius: 50%" >
                <p class="text-profile">Bienvenue {{ Auth::user()->name }}</p>
            </a>
        @endif
        <a href="#section-section1" class="col-md-1 bouton-nav myNavbar nav-selected" id="nav-page1"><p>Accueil</p></a>
